...
c     Wrapper subroutine calling the Recola real-emission ME.
      use recola_powheg, only: recola_real
      implicit none
      include 'pwhg_math.h'
      include 'pwhg_st.h'
      include 'nlegborn.h'
...
c a (leading) color structure to an event.
      use recola_powheg, only: recola_realcolour_ifl
      implicit none
      include 'nlegborn.h'
      include 'pwhg_flst.h'
      include 'pwhg_rad.h'
 ...
 1    continue
      ...
      call recola_realcolour_ifl(p0,rflav0,color,ifl)
